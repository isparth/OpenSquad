...
- Current scope: desktop bot management, agent CRUD/avatars, the runtime adapter, and S2a's conversation/run backend. Credential onboarding, authenticated Composio MCP provisioning, skills/artifact transfer, and desktop chat/execution UI are not implemented yet. Do not call this end-to-end agent chat.
