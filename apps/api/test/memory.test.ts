...
describe("memory documents", () => {
  ...
  it("adds empty-state memory guidance when auto-update is enabled by default", async () => {
  ...
  it("leaves bot instructions unchanged when auto-update is disabled for empty memory", async () => {
